...
setwd("D:\\bioinfor\\sepsis\\glycolysis\\21.2 GO")             #设置工作目录
rt=read.table("interGenes.txt", header=T, sep="\t", check.names=F)     #读取输入文件
...
#柱状图
pdf(file="barplot.pdf", width=11, height=9)
...
#气泡图
pdf(file="bubble.pdf", width=11, height=9)
